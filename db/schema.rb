...
ActiveRecord::Schema.define(version: 20150823222605) do
  ...
  add_index "categories", ["code_id"], name: "index_categories_on_code_id", using: :btree
  ...
  add_foreign_key "categories", "codes"
